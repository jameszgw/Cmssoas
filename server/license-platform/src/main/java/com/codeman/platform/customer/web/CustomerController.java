package com.codeman.platform.customer.web;

import com.codeman.platform.customer.domain.Customer;
import com.codeman.platform.customer.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<byte[]> exportCsv() {
        ...
        return com.codeman.platform.common.CsvUtil.response("customers.csv",
