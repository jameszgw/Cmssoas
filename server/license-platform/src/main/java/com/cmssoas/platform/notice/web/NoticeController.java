...
import com.cmssoas.platform.notice.dto.NoticeDtos.CreateReq;
import com.cmssoas.platform.notice.dto.NoticeDtos.UpdateReq;
...
public class NoticeController {
    ...
    public ResponseEntity<byte[]> exportConsents() {
        ...
        return com.cmssoas.platform.common.CsvUtil.response("consents.csv",
