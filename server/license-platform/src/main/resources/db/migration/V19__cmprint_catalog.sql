...
INSERT INTO feature_version(feature_code,version,available) VALUES
 ('theme','v0.5',TRUE),('dataSource','v0.5',TRUE),('preview','v0.5',TRUE),('print','v0.5',TRUE),
 ('directPrint','v0.5',TRUE),('watermark','v0.5',TRUE),('overprint','v0.5',TRUE),('calibration','v0.5',TRUE),
 ('exportJson','v0.5',TRUE),('exportPdf','v0.5',TRUE),('exportPdfText','v0.5',TRUE),('sharePdf','v0.5',TRUE),
 ('exportWord','v0.5',TRUE),('exportExcel','v0.5',TRUE),('exportImage','v0.5',TRUE),
 ('subTemplate','v0.5',TRUE),('templateGallery','v0.5',TRUE);
