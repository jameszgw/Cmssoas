...
-- ---------- V19__cmreport_catalog.sql ----------
-- [MySQL 方言] 由 db/migration/V19__cmreport_catalog.sql 机械转换:本迁移仅 INSERT,无方言差异。
...
ALTER TABLE license MODIFY signature VARCHAR(512) NOT NULL;
ALTER TABLE license_history MODIFY signature VARCHAR(512) NOT NULL;
